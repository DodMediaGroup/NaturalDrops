			...
			<div class="col-sm-6">
				...
				<div class="my-collapse">
					...
					<div class="collapse">
						...
						<p>Además del Cannabis como componente principal, Natural Drops, tiene en su fórmula Castaño de Indias y Árnica, que potencializan las propiedades terapéuticas del Cannabis permitiendo que su efecto antiinflamatorio y analgésico. También se le incluyó Aloe Vera, Manzanilla y Vitamina E que favorecen su absorción y le agregan propiedades humectantes y recuperadoras de los tejidos de la piel.</p>
				...
				<div class="my-collapse">
					...
					<div class="collapse">
						<p>Aplicar dos veces al día en el área a tratar y esparcir sobre la piel con un suave masaje hasta que sea absorbida completamente.</p>
					</div>
				</div>
				<div class="my-collapse">
				...
				<p class="presentations">Frasco 100 gr</p>
				<h2 class="title">Precio <span>$ 32.000</span></h2>
				<div class="buttons">
					<div class="col-md-6">
						<a href="#" id="modal_sale"><span><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/icons/markers.svg" class="js-img-to-svg"></span> COMPRAR EN LÍNEA</a>
					</div>
					<div class="col-md-6">
