...
class QuestionsController extends Controller
{
    ...
    public function actionAdmin()
    {
        ...
        $questions = Questions::model()->findAll(array('condition'=>'t.status != 2', 'order'=>'t.id_question DESC'));
    ...
    {
        $model=Questions::model()->findByAttributes(array('id_question'=>$id), array('condition'=>'t.status != 2'));
        if($model===null)
            throw new CHttpException(404,'The requested page does not exist.');
        return $model;
    }
