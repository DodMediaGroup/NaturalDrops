					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group">
		        				...
		        				<?php echo $form->textField($model,'office',array('class'=>'form-control','maxlength'=>255,'placeholder'=>'Cargo','required'=>true)); ?>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<div class="imag-before-upload" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/admin/gray.png); max-width: 180px;">
									<?php if(!$model->isNewRecord && $model->image != ""){ ?>
										<div class="img" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/team/<?php echo $model->image; ?>)"></div>
									<?php } ?>
								</div>
