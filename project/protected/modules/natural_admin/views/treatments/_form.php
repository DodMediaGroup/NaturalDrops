	...
	<div class="row">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
		        				...
		        				<?php echo $form->textField($model,'treatment',array('class'=>'form-control','maxlength'=>255,'placeholder'=>'Tratamiento','required'=>true)); ?>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="imag-before-upload" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/admin/gray.png); max-width: 180px;">
									<?php if(!$model->isNewRecord && $model->image != ""){ ?>
										<div class="img" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/treatments/<?php echo $model->image; ?>)"></div>
									<?php } ?>
								</div>
								...
								<p class="help-block"><strong>Nota: </strong> Dimensiones recomendadas de 500x500. Peso maximo 256Kb.</p>
							</div>
						</div>
					</div>
					<div class="form-group">
						<?php echo $form->labelEx($model,'benefits'); ?>
						<?php echo $form->textArea($model,'benefits',array('class'=>'js-ckeditor')); ?>
					</div>
					<div class="form-group">
		...
		<div class="col-sm-12">
			<div class="form-group">
                ...
                <a href="<?php echo $this->createUrl('testimonials/admin'); ?>" class="btn btn-danger">Cancelar</a>
			</div>
		</div>
	</div>
<?php $this->endWidget(); ?>